...
# The 1 at the last signifies that images are of binary color format, 
# i.e. gray scale
...
# For the very first layer in the model, input_shape attribute should
# be mentioned
...
# create a pandas dataset with all the keys stored in the history
# object
